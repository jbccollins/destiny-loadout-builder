...
// 	createHttpClient(
// 		makePretendFetch(response) as any as typeof fetch,
// 		'123',
// 		false
// 	);
...
// test.each(cases)(
// 	'check Request builder for %p',
// 	async (apiFunc, apiFuncParams) => {
// 		const request: TroubleshootingResponse = await apiFunc(
// 			pretendHttpClient(),
// 			apiFuncParams
// 		);
