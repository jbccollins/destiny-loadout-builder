...
export const AspectIdToAspectMapping: EnumDictionary<EAspectId, IAspect> = {
  ...
  [EAspectId.OnYourMark]: {
    ...
    description:
      "Activating your class ability or getting precision final blows grant you and nearby allies increased weapon handling and reload speed for a short duration. Stacks three times.\n\nPrecision final blows while at three stacks make you radiant for a short time.",
