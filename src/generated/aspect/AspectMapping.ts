...
export const AspectIdToAspectMapping: EnumDictionary<EAspectId, IAspect> = {
	...
	[EAspectId.Hellion]: {
		...
		description:
			'Your Solar abilities and weapons cause targets to burn on hit. Burning targets take additional damage over time.',
		icon: 'https://www.bungie.net/common/destiny2_content/icons/7f3e8b0b0e9d2c4e3e9f9a0b5b0e0c0f.jpg',
		hash: 4249729128,
		fragmentSlots: 2,
	},
	[EAspectId.Unbreakable]: {
		...
		description:
			'Your barricade gains additional health and is larger, and you gain an additional barricade charge.',
		icon: 'https://www.bungie.net/common/destiny2_content/icons/6d6d5b5a5a1b2c1f3f2c1a9d9f3a1b2f.jpg',
		hash: 4249729129,
		fragmentSlots: 2,
	},
	[EAspectId.Ascension]: {
		...
		description:
			'Your Rifts gain additional health and are larger, and you gain an additional Rift charge.',
		icon: 'https://www.bungie.net/common/destiny2_content/icons/0c6b1f8c4e6b1b7f7e6b1b7f7e6b1b7f.jpg',
		hash: 4249729130,
		fragmentSlots: 2,
	},
};
