...
export const JumpIdToJumpMapping: EnumDictionary<EJumpId, IJump> = {
  ...
  [EJumpId.CatapultLiftPrismTitan]: {
    name: "Catapult Lift",
    id: EJumpId.CatapultLiftPrismTitan,
    description:
      "Jump while airborne to activate Lift and launch into the air with a strong initial burst of momentum.",
    icon: "https://www.bungie.net/common/destiny2_content/icons/c09cce402f29548803f4a3f352b03f14.png",
    hash: 266130437,
    elementId: EElementId.Prism,
  },
  [EJumpId.StrafeLiftPrismTitan]: {
    name: "Strafe Lift",
    id: EJumpId.StrafeLiftPrismTitan,
    description:
      "Jump while airborne to activate Lift and launch into the air with strong directional control.",
    icon: "https://www.bungie.net/common/destiny2_content/icons/157c2ce4c58e099c8d70cfe65815beaf.png",
    hash: 266130438,
    elementId: EElementId.Prism,
  },
  [EJumpId.HighLiftPrismTitan]: {
    name: "High Lift",
    id: EJumpId.HighLiftPrismTitan,
    description:
      "Jump while airborne to activate Lift and launch into the air to greater heights.",
    icon: "https://www.bungie.net/common/destiny2_content/icons/44a4432af0a32959a19049ce5a89dc14.png",
    hash: 266130439,
    elementId: EElementId.Prism,
  },
  ...
  [EJumpId.TripleJumpPrismHunter]: {
    name: "Triple Jump",
    id: EJumpId.TripleJumpPrismHunter,
    description:
      "While airborne, sustain your air control with a second or third jump.",
    icon: "https://www.bungie.net/common/destiny2_content/icons/d928a3ef4498d2a714d69ba81f45ac25.png",
    hash: 1588878497,
    elementId: EElementId.Prism,
  },
  [EJumpId.StrafeJumpPrismHunter]: {
    name: "Strafe Jump",
    id: EJumpId.StrafeJumpPrismHunter,
    description:
      "While airborne, jump a second time with strong directional control.",
    icon: "https://www.bungie.net/common/destiny2_content/icons/2cd8dc264af1af2c293b2b009dc3ed46.png",
    hash: 1588878498,
    elementId: EElementId.Prism,
  },
  [EJumpId.HighJumpPrismHunter]: {
    name: "High Jump",
    id: EJumpId.HighJumpPrismHunter,
    description: "While airborne, jump a second time to reach greater heights.",
    icon: "https://www.bungie.net/common/destiny2_content/icons/4fa48bb6e4ddecc0f19616a67adc5c45.png",
    hash: 1588878499,
    elementId: EElementId.Prism,
  },
