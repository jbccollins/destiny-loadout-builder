...
export const isRunningProcessArmorWebWorkerSlice = createSlice({
  ...
  initialState,
  reducers: {
    setIsRunningProcessArmorWebWorker: (state, action: PayloadAction<boolean>) => {
...
export const { setIsRunningProcessArmorWebWorker } = isRunningProcessArmorWebWorkerSlice.actions;
