// This file just contains enums that were exported as consts in the the
// 'bungie-api-ts' package. For whatever dumbass fucking reason I get this
// asinine fucking error when trying to import them directly:
// Cannot access ambient const enums when the '--isolatedModules' flag is provided
// The fix is to just change "export declare const enum PlatformErrorCodes" to
// "export declare enum PlatformErrorCodes"

// TODO: Fix this fucking bullshit and remove this folder completely. This will probably
// invove adding a .babelrc file to this project and doing some shit with optimizeConstEnums
// References: https:github.com/DestinyItemManager/DIM/blob/d73a8cb51fa92a4ee3033d8564538630b7d1492a/babel.config.js#L46
// https:github.com/DestinyItemManager/bungie-api-ts-no-const-enum/issues/38

// Copied from "bungie-api-ts-no-const-enum/user"
